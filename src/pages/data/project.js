const projects = [
...

  {
  ...
  },
   {
    id: 24,
    title: "RecipeFinder",
    subtitle: "Intelligent Recipe, Nutrition & Food Marketplace",
    description:
      "A full-stack food discovery and nutrition platform that combines recipe discovery, pantry management, meal planning, nutrition tracking, food-store mapping, shopping and real-time order management.",
    ...
    diabeticMealPlanning: [
      "Diabetic-Friendly Meal Categories",
